...
REQUIRED_FILES = (
    ...
    "docs/adr/0031-persisted-decision-analysis.md",
    ...
    "services/api/alembic/versions/0007_widget_domain_security.py",
    "services/api/alembic/versions/0009_decision_artifacts.py",
    ...
    "services/api/app/widget_security.py",
    "services/api/app/widget_api.py",
    "services/api/app/decision_analysis_models.py",
    "services/api/app/decision_analysis_persistence.py",
    "services/api/app/investment_scenario_api.py",
    ...
    "services/api/tests/test_widget_origin_normalization.py",
    "services/api/tests/test_widget_security_api.py",
    "services/api/tests/test_investment_scenario_api.py",
...
AGENT_GUARDRAILS = (
    ...
    "Widget browser içine gizli kabul edilen API key/client secret gömemez",
    "Widget Origin allowlist yalnız exact HTTPS DNS origin kabul eder",
